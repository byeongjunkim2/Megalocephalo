...
namespace KinematicCharacterController
{
    ...
    public class SCR_BaseCharController : MonoBehaviour, ICharacterController
    {
        ...
        public float OrientationSharpness = 25f;
        ...
        public Vector3 Gravity = new Vector3(0, -80f, 0);
        ...
        public void SetInputs(ref PlayerCharacterInputs inputs)
        {
            ...
            //Vector3 moveInputVector = new Vector3(inputs.MoveAxisRight, 0f, 0f);
                ...
                case CharacterState.Default:
                    {
                        ...
                        switch (OrientationMethod)
                        {
                            ...
                            case OrientationMethod.TowardsMovement:
                              ...
                              //  _lookInputVector = moveDirection;
                                break;
                        }
                ...
                case CharacterState.Default:
                    {
                        ...
                        else
                        {
                            ...
                            currentVelocity = Vector3.Lerp(currentVelocity, _moveInputVector * MaxAirMoveSpeed, 1f - Mathf.Exp(-StableMovementSharpness * deltaTime));
                            currentVelocity = new Vector3(currentVelocity.x, yVelocity, currentVelocity.z);
